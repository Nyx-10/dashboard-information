...
export const dict = {
  en: {
    ...
    badgeLost: 'Lost', badgeFound: 'Found', badgeInfo: 'Info', normalUser: 'Normal User', today: 'Today', messageFrom: 'Message from', deleteBtn: 'Delete'
  },
  ms: {
    ...
    badgeLost: 'Hilang', badgeFound: 'Jumpa', badgeInfo: 'Info', normalUser: 'Pengguna Biasa', today: 'Hari ini', messageFrom: 'Mesej dari', deleteBtn: 'Padam'
  },
  zh: {
    ...
    badgeLost: '丢失', badgeFound: '寻获', badgeInfo: '信息', normalUser: '普通用户', today: '今天', messageFrom: '来自', deleteBtn: '删除'
  },
  ta: {
    ...
    badgeLost: 'தொலைந்தவை', badgeFound: 'கிடைத்தவை', badgeInfo: 'தகவல்', normalUser: 'சாதாரண பயனர்', today: 'இன்று', messageFrom: 'இருந்து செய்தி', deleteBtn: 'அழி'
  }
};
