...
export const dict = {
  ...
  zh: {
    ...
    badgeLost: '丢失', badgeFound: '寻获', badgeInfo: '信息', normalUser: '普通用户', today: '今天', messageFrom: '来自', deleteBtn: '删除', cannotContactSelf: '您不能联系自己。', confirmResolveReport: '您确定要将此报告标记为已解决吗？', markResolved: '已解决',
    ...
    suspendModalTitle: '暂停用户账户', suspendDurationLabel: '选择暂停时长', dayCount1: '1 天', dayCount3: '3 天', dayCount7: '7 天', dayCount14: '14 天', dayCount30: '30 天', customDays: '自定义天数', indefinite: '永久（无期限）', suspendedUntilDate: '暂停至', confirmSuspendBtn: '暂停账户',
    logRoleChange: '更改用户角色 ({email}) 为 {role}',
    emailRoleChangeTitle: '帐户角色已更新',
    emailRoleChangeMsg: '您的 ADTEC 仪表板帐户角色已被管理员更改为 {role}。',
    logUnsuspend: '重新激活用户帐户 ({email})',
    logSuspendDays: '暂停用户帐户 ({email}) {days} 天 (直到 {date})',
    logSuspendPermanent: '永久暂停用户帐户 ({email})',
    logDeleteUser: '完全删除用户 ({email})',
    logReportStatus: '更改报告状态 ({email}) 为 {status}',
    emailAccountActivatedTitle: '帐户已重新激活',
    emailAccountActivatedMsg: '好消息！您的 ADTEC 仪表板帐户已被管理员重新激活。您现在可以正常登录。',
    emailAccountSuspendedTitle: '帐户暂停通知',
    emailAccountSuspendedMsg1: '您的 ADTEC 仪表板帐户因违反条款和条件已被管理员暂停。',
    emailAccountSuspendedMsgDays: '您的帐户将被暂停 {days} 天，可以在 {date} 后再次访问。',
    emailAccountSuspendedMsgPermanent: '您的帐户已被永久暂停。如果这是一个错误，请联系管理部门。',
    notifReportStatusTitle: '报告状态已更新',
    notifReportStatusMsg: '您针对 {name} 的报告现在为：{status}。',
  ...
  ta: {
    ...
    badgeLost: 'தொலைந்தவை', badgeFound: 'கிடைத்தவை', badgeInfo: 'தகவல்', normalUser: 'சாதாரண பயனர்', today: 'இன்று', messageFrom: 'இருந்து செய்தி', deleteBtn: 'அழி', cannotContactSelf: 'உங்களை நீங்கள் தொடர்புகொள்ள முடியாது.', confirmResolveReport: 'இந்த அறிக்கையைத் தீர்க்கப்பட்டதாகக் குறிக்க விரும்புகிறீர்களா?', markResolved: 'தீர்க்கப்பட்டது',
    ...
    suspendModalTitle: 'பயனர் கணக்கை இடைநிறுத்து', suspendDurationLabel: 'இடைநிறுத்தக் காலத்தைத் தேர்ந்தெடுக்கவும்', dayCount1: '1 நாள்', dayCount3: '3 நாட்கள்', dayCount7: '7 நாட்கள்', dayCount14: '14 நாட்கள்', dayCount30: '30 நாட்கள்', customDays: 'விருப்ப நாட்கள்', indefinite: 'நிரந்தரமானது', suspendedUntilDate: 'வரை இடைநிறுத்தப்பட்டது', confirmSuspendBtn: 'கணக்கை இடைநிறுத்து',
    logRoleChange: 'பயனர் பங்கை ({email}) {role} ஆக மாற்றினார்',
    emailRoleChangeTitle: 'கணக்கு பங்கு புதுப்பிக்கப்பட்டது',
    emailRoleChangeMsg: 'உங்கள் ADTEC டாஷ்போர்டு கணக்கு பங்கு நிர்வாகியால் {role} ஆக மாற்றப்பட்டுள்ளது.',
    logUnsuspend: 'பயனர் கணக்கை மீண்டும் செயல்படுத்தினார் ({email})',
    logSuspendDays: 'பயனர் கணக்கை ({email}) {days} நாட்களுக்கு இடைநிறுத்தினார் ({date} வரை)',
    logSuspendPermanent: 'பயனர் கணக்கை நிரந்தரமாக இடைநிறுத்தினார் ({email})',
    logDeleteUser: 'பயனரை நிரந்தரமாக நீக்கினார் ({email})',
    logReportStatus: 'அறிக்கை நிலையை ({email}) {status} ஆக மாற்றினார்',
    emailAccountActivatedTitle: 'கணக்கு மீண்டும் செயல்படுத்தப்பட்டது',
    emailAccountActivatedMsg: 'நல்ல செய்தி! உங்கள் ADTEC டாஷ்போர்டு கணக்கு நிர்வாகியால் மீண்டும் செயல்படுத்தப்பட்டது. நீங்கள் இப்போது சாதாரணமாக உள்நுழையலாம்.',
    emailAccountSuspendedTitle: 'கணக்கு இடைநிறுத்த அறிவிப்பு',
    emailAccountSuspendedMsg1: 'விதிமுறைகள் மற்றும் நிபந்தனைகளை மீறியதற்காக உங்கள் ADTEC டாஷ்போர்டு கணக்கு நிர்வாகியால் இடைநிறுத்தப்பட்டுள்ளது. ',
    emailAccountSuspendedMsgDays: 'உங்கள் கணக்கு {days} நாட்களுக்கு இடைநிறுத்தப்படும் மற்றும் {date} க்குப் பிறகு மீண்டும் அணுகலாம்.',
    emailAccountSuspendedMsgPermanent: 'உங்கள் கணக்கு நிரந்தரமாக இடைநிறுத்தப்பட்டுள்ளது. இது ஒரு தவறு என்றால் தயவுசெய்து நிர்வாகத்தைத் தொடர்பு கொள்ளவும்.',
    notifReportStatusTitle: 'அறிக்கை நிலை புதுப்பிக்கப்பட்டது',
    notifReportStatusMsg: '{name} மீதான உங்கள் அறிக்கை இப்போது: {status}.',
    emailReportStatusTitle: 'உங்கள் அறிக்கை நிலை புதுப்பிக்கப்பட்டுள்ளது',
    emailReportStatusMsg: 'பயனர் {name} மீதான உங்கள் அறிக்கை நிர்வாகியால் மதிப்பாய்வு செய்யப்பட்டது, இப்போது: {status}. ADTEC Melaka சமூகத்திற்கு உதவியதற்கு நன்றி.',
    suspendPreviewPermanent: '🔒 கணக்கு கைமுறையாக மீண்டும் செயல்படுத்தப்படும் வரை நிரந்தரமாக இடைநிறுத்தப்படும்.',
    suspendPreviewDays: '⏰ கணக்கு இது வரை இடைநிறுத்தப்படும்: {date} (காலம் முடிந்த பிறகு கணினி தானாகவே இடைநிறுத்தத்தை ரத்து செய்யும்)'
  },
  ms: {
    dashboard: 'Papan Pemuka', searchItems: 'Cari Barang', missingItem: 'Barang Hilang & Info Kolej', messages: 'Mesej',
    adminPanel: 'PANEL ADMIN', analytics: 'Analitik', manageUsers: 'Urus Pengguna', manageReports: 'Urus Laporan', auditLogs: 'Log Audit',
