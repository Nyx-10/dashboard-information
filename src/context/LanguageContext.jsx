...
export const dict = {
  en: {
    ...
    heroTitle: 'Information Dashboard', heroSubtitle: 'Lost & found management, college information, and campus community communication in one modern and secure platform.',
    ...
    pleaseLoginAgain: 'Please login again.', profilePicSuccess: 'Profile picture changed successfully!', profileSaveSuccess: 'Profile saved successfully!', profileSaveError: 'Error: Please make sure you have run the SQL script (add_profile_features.sql) in the Supabase database.', passwordChangeSuccess: 'Password changed successfully!', failedUpdateReport: 'Failed to update report.', trustedFinder: 'Trusted Finder', changeProfilePic: 'Change Profile Picture', themeColor: 'Theme Color', switchToLightMode: 'Switch to Light Mode', switchToDarkMode: 'Switch to Dark Mode', activePending: 'Active (Pending)', profileNotifs: 'Profile & Notifications', reportHistory: 'Report History', security: 'Security', updateInfo: 'Update Information', departmentCourse: 'Department / Course', deptPlaceholder: 'e.g. Computer Engineering', notifSettings: 'Notification Settings', emailNotifDesc: 'Receive email when a new message arrives.', savedTick: '✓ Saved', saveProfile: 'Save Profile', updatePassword: 'Update Password', noReportsForCategory: 'No reports found for this category.'
  },
  ms: {
    ...
    heroTitle: 'Dashboard Maklumat', heroSubtitle: 'Sistem pengurusan barang hilang & jumpa, maklumat institusi, dan komunikasi sesama warga dalam satu platform yang moden dan selamat.',
    ...
    darkMode: 'Dark Mode', lightMode: 'Light Mode',
    pleaseLoginAgain: 'Sila log masuk semula.', profilePicSuccess: 'Gambar profil berjaya ditukar!', profileSaveSuccess: 'Profil berjaya disimpan!', profileSaveError: 'Ralat: Sila pastikan anda telah menjalankan script SQL (add_profile_features.sql) di pangkalan data Supabase.', passwordChangeSuccess: 'Kata laluan berjaya ditukar!', failedUpdateReport: 'Gagal mengemas kini laporan.', trustedFinder: 'Pencari Dipercayai', changeProfilePic: 'Tukar Gambar Profil', themeColor: 'Warna Tema', switchToLightMode: 'Tukar ke Light Mode', switchToDarkMode: 'Tukar ke Dark Mode', activePending: 'Sedang Aktif (Pending)', profileNotifs: 'Profil & Notifikasi', reportHistory: 'Sejarah Laporan', security: 'Keselamatan', updateInfo: 'Kemas Kini Maklumat', departmentCourse: 'Jabatan / Kursus', deptPlaceholder: 'Contoh: Kejuruteraan Komputer', notifSettings: 'Tetapan Notifikasi', emailNotifDesc: 'Terima e-mel apabila ada mesej baru masuk.', savedTick: '✓ Disimpan', saveProfile: 'Simpan Profil', updatePassword: 'Kemas Kini Kata Laluan', noReportsForCategory: 'Tiada laporan dijumpai untuk kategori ini.'
  }
};
