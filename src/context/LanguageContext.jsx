...
export const dict = {
  ...
  zh: {
    ...
    noReportsFound: 'No reports found.', approve: 'Approve', reject: 'Reject', resolve: 'Resolve', viewImage: 'View Image', pending: 'Pending', approved: 'Approved', rejected: 'Rejected', resolved: 'Resolved', overlayWelcomeTitle: 'Welcome Back!', overlayWelcomeDesc: 'To keep connected with us please login with your personal info', overlayHelloTitle: 'Hello, Friend!', overlayHelloDesc: 'Enter your personal details and start your journey with us',
  ...
  zh: {
    ...
    exportCsv: '导出 (CSV)', maintenanceMode: '维护模式', maintenanceActive: '启用', maintenanceInactive: '未启用', maintenanceDesc: '如果启用，普通用户将无法登录系统，直到其被关闭。', maintenanceTurnOn: '启用 (On)', maintenanceTurnOff: '关闭 (Off)', confirmMaintenanceToggle: '您确定要切换维护模式吗？', systemUnderMaintenance: '系统维护中', maintenanceReturnMsg: '我们正在进行维护以改善系统。请稍后再来。给您带来的不便，我们深表歉意。', returnToLogin: '返回登录', overlayWelcomeTitle: '欢迎回来！', overlayWelcomeDesc: '为了与我们保持联系，请使用您的个人信息登录。', overlayHelloTitle: '你好，朋友！', overlayHelloDesc: '输入您的个人详细信息，开始您的旅程。',
    uploadScreenshot: '上传截图 / 凭证', screenshotNotice: '请上传截图凭证，以便管理员核实此报告并防止虚假举报。', viewProof: '查看凭证', noProofProvided: '未提供截图', proofModalTitle: '举报截图凭证', screenshotRequired: '提交前请上传截图凭证。'
  },
  ta: {
    ...
    exportCsv: 'ஏற்றுமதி (CSV)', maintenanceMode: 'பராமரிப்பு முறை', maintenanceActive: 'செயலில்', maintenanceInactive: 'செயலற்றது', maintenanceDesc: 'செயல்படுத்தப்பட்டால், சாதாரண பயனர்கள் அதை அணைக்கப்படும் வரை கணினியில் உள்நுழைய முடியாது.', maintenanceTurnOn: 'ஆன் (On)', maintenanceTurnOff: 'ஆஃப் (Off)', confirmMaintenanceToggle: 'பராமரிப்பு முறையை மாற்ற விரும்புகிறீர்களா?', systemUnderMaintenance: 'கணினி பராமரிப்பில் உள்ளது', maintenanceReturnMsg: 'கணினியை மேம்படுத்த பராமரிப்பு பணிகளைச் செய்து வருகிறோம். தயவுசெய்து பின்னர் மீண்டும் வரவும். சிரமத்திற்கு வருந்துகிறோம்.', returnToLogin: 'உள்நுழைவுக்குத் திரும்பு', overlayWelcomeTitle: 'மீண்டும் வரவேற்கிறோம்!', overlayWelcomeDesc: 'எங்களுடன் இணைந்திருக்க தயவுசெய்து உங்கள் தனிப்பட்ட தகவல்களுடன் உள்நுழையவும்.', overlayHelloTitle: 'வணக்கம், நண்பரே!', overlayHelloDesc: 'உங்கள் தனிப்பட்ட விவரங்களை உள்ளிட்டு எங்களுடன் உங்கள் பயணத்தைத் தொடங்கவும்.',
    uploadScreenshot: 'ஸ்கிரீன்ஷாட் / சான்றுகளைப் பதிவேற்றவும்', screenshotNotice: 'போலி புகார்களைத் தவிர்க்க நிர்வாகி இந்த அறிக்கையைச் சரிபார்க்க ஸ்கிரீன்ஷாட் சான்றுகளைப் பதிவேற்றவும்.', viewProof: 'சான்றைக் காண்க', noProofProvided: 'ஸ்கிரீன்ஷாட் வழங்கப்படவில்லை', proofModalTitle: 'அறிக்கை சான்று ஸ்கிரீன்ஷாட்', screenshotRequired: 'சமர்ப்பிப்பதற்கு முன் ஸ்கிரீன்ஷாட் சான்றைப் பதிவேற்றவும்.'
  }
};
